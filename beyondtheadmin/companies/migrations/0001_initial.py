            ...
            fields=[
                ...
                (
                    ...
                    localflavor.generic.models.BICField(
                        blank=True, max_length=11, verbose_name="BIC"
                    ),
                ),
                (
                    "iban",
                ...
                (
                    "logo",
                    models.ImageField(blank=True, null=True, upload_to="", verbose_name="Logo"),
                ),
                (
                    "contrast_color",
                    colorfield.fields.ColorField(
                        default="#3B4451", max_length=18, verbose_name="Contrast color"
                    ),
                ),
                (
                    "signature_text",
                    models.CharField(blank=True, max_length=100, verbose_name="Signature as text"),
                ),
                (
                    "signature_image",
                    models.ImageField(
