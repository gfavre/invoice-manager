...
class ClientForm(forms.ModelForm):
    ...
    def __init__(self, *args, user, **kwargs):
        ...
        self.fields["company_name"].widget.attrs["data-search-url"] = reverse_lazy(
            "api:companies-autocomplete"
        )
        self.fields["company_name"].widget.attrs["data-detail-url"] = reverse_lazy(
            "api:company-detail"
        )
        ...
        self.helper.layout = Layout(
            ...
            Fieldset(
                ...
                "person_address",
                Row(
                    Column("person_country", css_class="col-md-4"),
                    Column("person_zipcode", css_class="col-md-2"),
                    Column("person_city"),
                ),
                "person_email",
